...
# 3. Run this script: bash collection_utils/get_datasets.sh

SYNTHETIC_NUM_SAMPLES=10000

python src/collection_utils/data_collector.py --download_all
python src/collection_utils/synthetic_data_generator.py --num_samples $SYNTHETIC_NUM_SAMPLES